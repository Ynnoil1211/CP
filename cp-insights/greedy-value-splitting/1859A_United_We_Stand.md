...
"Partition array into two non-empty arrays $b$ and $c$ such that no element of $c$ divides any element of $b$." Divisibility requires $c_j \le b_i$. Hence, setting all elements of $c$ strictly greater than all elements of $b$ mechanically eliminates any possible divisor relationship.
